...
const Home: React.FC = () => {
  ...
  const categories = [
    { 
      ...
      count: '24 Models',
      image: 'https://imgur.com/v67c94r.png',
    ...
    { 
      ...
      icon: <Watch size={24} />, 
      count: '18 Models',
      image: 'https://imgur.com/uJCoR9j.png',
    ...
    { 
      ...
      count: '32 Items',
      image: 'https://imgur.com/I07Wass.png',
    ...
    { 
      ...
      count: '45 Devices',
      image: 'https://imgur.com/YN9oqGB.png',
    ...
    { 
      ...
      count: '15 Consoles',
      image: 'https://imgur.com/C8XprYT.png',
          ...
          <div className="relative order-1 lg:order-2 animate-float">
            <div className="relative z-10 w-full aspect-square glass-panel p-8 flex items-center justify-center shadow-2xl shadow-purple-200/50 border-white/80">
               ...
               <div className="relative w-full h-full rounded-[2rem] overflow-hidden group">
                  ...
                  <img src="https://imgur.com/UfLwejk.png" alt="Future Tech" className="absolute inset-0 w-full h-full object-cover rounded-[2rem] transition-transform duration-700 group-hover:scale-105" />
                  ...
                  {categories.map((cat, idx) => (
                     <RevealOnScroll key={cat.name} delay={idx * 100} className="w-full">
                       <Link 
                         ...
                         className={`group relative block w-full aspect-square rounded-[2rem] overflow-hidden border border-white/20 shadow-xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 ${cat.hoverShadow} ${cat.hoverBorder}`}
                       >
         ...
         <div className="container mx-auto px-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                 <RevealOnScroll className="h-full">
                   <Link to="/category/Gaming" className="group relative block h-80 rounded-[2rem] overflow-hidden shadow-xl shadow-purple-100">
                      <img src="https://imgur.com/PUpFwdx.png" alt="Gaming" loading="lazy" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                 ...
                 <RevealOnScroll delay={200} className="h-full">
                   <Link to="/category/Smart Home" className="group relative block h-80 rounded-[2rem] overflow-hidden shadow-xl shadow-blue-100">
                      <img src="https://imgur.com/51ZcYs8.png" alt="Smart Home" loading="lazy" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>
                      <div className="absolute bottom-0 left-0 p-10">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
                ...
                <RevealOnScroll delay={300} className="h-full">
                  <div className="relative h-64 lg:h-96 glass-card p-2 overflow-hidden shadow-lg transform rotate-2 hover:rotate-0 transition-transform duration-500">
                    <img src="https://images.unsplash.com/photo-1550009158-9ebf69173e03?auto=format&fit=crop&q=80&w=800" alt="Technology" loading="lazy" className="w-full h-full object-cover rounded-2xl" />
